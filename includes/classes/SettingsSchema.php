...
class SettingsSchema {
	...
	public static function fields( array $context = array() ) {
		...
		return array(
			...
			'enable_sucuri'                    => self::field( self::TYPE_BOOLEAN, false, 'integrations', self::SANITIZE_BOOLEAN, true ),
			'sucuri_api_key'                   => self::field( self::TYPE_STRING, '', 'integrations', self::SANITIZE_TEXT, true, array( 'enable_sucuri' ) ),
			'sucuri_api_secret'                => self::field( self::TYPE_STRING, '', 'integrations', self::SANITIZE_TEXT, true, array( 'enable_sucuri' ) ),

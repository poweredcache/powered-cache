...
class SettingsSchema {
	...
	public static function fields( array $context = array() ) {
		...
		return array(
			...
			'enable_sitemap_preload'           => self::field( self::TYPE_BOOLEAN, false, 'preload', self::SANITIZE_BOOLEAN ),
			'preload_request_interval'         => self::field( self::TYPE_INTEGER, 2, 'preload', self::SANITIZE_INTEGER ),
			'preload_sitemap'                  => self::field( self::TYPE_STRING, '', 'preload', self::SANITIZE_TEXTAREA, false, array( 'enable_sitemap_preload' ) ),
			...
			'prefetch_links'                   => self::field( self::TYPE_BOOLEAN, true, 'preload', self::SANITIZE_BOOLEAN ),
			...
			'enable_varnish'                   => self::field( self::TYPE_BOOLEAN, false, 'integrations', self::SANITIZE_BOOLEAN ),
			'varnish_ip'                       => self::field( self::TYPE_STRING, '', 'integrations', self::SANITIZE_TEXTAREA, false, array( 'enable_varnish' ) ),
